def pesquisar_por_nome(nome):
    ...
    for um_registro in registros:
        ...
        nome_paciente, idade, endereco, telefone, nome_responsavel = dados_do_registro

        if(nome in nome_paciente):
            # imprimir as variáveis formatadas como registro:
            print(f"Paciente: {nome_paciente}", f"- {idade} anos")
...
def pesquisar_por_idade(idade):
    ...
    for um_registro in registros:
        ...
        # guardar cada dado em uma variável
        nome, idade_paciente, endereco, telefone, nome_responsavel = dados_do_registro

        if(idade == idade_paciente):
            # imprimir as variáveis formatadas como registro:
            print(f"Paciente: {nome}", f"- {idade_paciente} anos")
            print(f"Fone: {telefone}",f"End.: {endereco}")
            print(f"Responsável: {nome_responsavel}")
            print()
